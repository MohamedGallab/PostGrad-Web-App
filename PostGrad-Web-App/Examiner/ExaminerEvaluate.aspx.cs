...
namespace PostGrad_Web_App
{
    public partial class ExaminerEvaluate : System.Web.UI.Page
    {
        ...
        protected void GradeDefense_Click(object sender, EventArgs e)
        {
            ...
            checkDefense.Parameters.Add(new SqlParameter("@serialNo", SqlDbType.VarChar)).Value = defenseNumber;
            checkDefense.Parameters.Add(new SqlParameter("@date", SqlDbType.VarChar)).Value = defenseDate;
            ...
            if (Convert.ToBoolean(success.Value))
            {
                ...
                examinerAddGrade.Parameters.Add(new SqlParameter("@ThesisSerialNo", SqlDbType.VarChar)).Value = defenseNumber;
                examinerAddGrade.Parameters.Add(new SqlParameter("@DefenseDate", SqlDbType.VarChar)).Value = defenseDate;
                examinerAddGrade.Parameters.Add(new SqlParameter("@grade", SqlDbType.VarChar)).Value = grade;
